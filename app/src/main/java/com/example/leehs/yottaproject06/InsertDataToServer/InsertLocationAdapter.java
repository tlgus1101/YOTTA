 ...
 */
public class InsertLocationAdapter extends BaseAdapter{
    private ArrayList<Item> mLocationList;
    private LayoutInflater mInflater;
    private boolean[] isChecked;

    public InsertLocationAdapter(ArrayList<Item> list, LayoutInflater inflater) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.insert_location_list, null);
            item = new ViewItem();
